class User < ApplicationRecord
  ...
  def self.remove_user_id_and_history(id, index)
    get_all_user_ids
    id_array = []
    id_array << id
    ...
    puts "id array:"
    user_matched_ids = []
    user_matched_ids = id.history_matched_ids
  ...
  def self.create_match(id, index)
